...
@pytest.mark.parametrize(
    "test_input", [["EnuS", "EngB"], ("EnuS", "EngB"), {"lang": "en", "country": "US"}]
)
...
@pytest.mark.parametrize("test_value", ["zzus", "enZZ"])
...
@pytest.mark.parametrize("test_input", [[1, 3, 4], (1, 3, 4), {"g": 1, "s": 3, "c": 4}])
