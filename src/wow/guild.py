...
class GuildAPI:
    ...
    def guild(self, locale: str, realm_name: str, guild_name: str) -> Dict[str, Any]:
        ...
        if self.client.release != 'retail':
            raise WoWReleaseError(f"{self.client.release} does not support the Guild Data API")

        data: Dict[str, Any] = self.client.game_data(locale, 'profile', 'guild', self.client.slugify(realm_name),
                                                     self.client.slugify(guild_name))
        return data
    
    @verify_client
    def guild_activities(self, locale: str, realm_name: str, guild_name: str) -> Dict[str, Any]:
        ...
        data: Dict[str, Any] = self.client.game_data(locale, 'profile', 'guild', self.client.slugify(realm_name),
                                                     self.client.slugify(guild_name), 'activity')
        return data
    
    @verify_client
    def guild_achievements(self, locale: str, realm_name: str, guild_name: str) -> Dict[str, Any]:
        ...
        data: Dict[str, Any] = self.client.game_data(locale, 'profile', 'guild', self.client.slugify(realm_name),
                                                     self.client.slugify(guild_name), 'achievements')
        return data
    
    @verify_client
    def guild_roster(self, locale: str, realm_name: str, guild_name: str) -> Dict[str, Any]:
        ...
        data: Dict[str, Any] = self.client.game_data(locale, 'profile', 'guild', self.client.slugify(realm_name),
                                                     self.client.slugify(guild_name), 'roster')
        return data
    ...
    def guild_crest_components_index(self, locale: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.game_data(locale, 'static', 'guild-crest', 'index')
        return data
    ...
    def guild_crest_border_media(self, locale: str, border_id: int) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.media_data(locale, 'static', 'guild-crest', 'border', border_id)
        return data
    ...
    def guild_crest_emblem_media(self, locale: str, crest_id: int) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.media_data(locale, 'static', 'guild-crest', 'emblem', crest_id)
        return data
