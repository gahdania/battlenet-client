...
class PlayableSpecAPI:
    ...
    @verify_client
    def playable_spec(self, locale: str, spec_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if spec_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'playable-specialization', spec_id)
        else:
            data = self.client.game_data(locale, 'static', 'playable-specialization', 'index')
        return data
    ...
    def playable_spec_media(self, locale: str, spec_id: int) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.media_data(locale, 'static', 'playable-specialization', spec_id)
        return data
