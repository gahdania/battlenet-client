...
class ReputationAPI:
    ...
    @verify_client
    def reputation_faction(self, locale: str, faction_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if faction_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'reputation-faction', faction_id)
        else:
            data = self.client.game_data(locale, 'static', 'reputation-faction', 'index')
        return data

    @verify_client
    def reputation_tier(self, locale: str, tier_id: Optional[int] = None) -> Dict[str, Any]:
        """Returns an index of reputation factions, or a specific reputation fa
        ...
        if tier_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'reputation-tiers', tier_id)
        else:
