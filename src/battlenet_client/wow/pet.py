...
class PetAPI:
    ...
    def pet(self, locale: str, pet_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if pet_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'pet', pet_id)
        else:
    ...
    def pet_ability(self, locale: str, pet_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        """
        if pet_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'pet-ability', pet_id)
        else:
    ...
    def pet_ability_media(self, locale: str, ability_id: int) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.media_data(locale, 'static', 'pet-ability', ability_id)
        return data
