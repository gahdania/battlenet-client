...
class CharacterAPI:
    ...
    @verify_client
    def achievement_summary(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                        self.client.slugify(character_name), 'achievements')
        return data

    @verify_client
    def achievement_statistics(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] =self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                       self.client.slugify(character_name), 'achievements', 'statistics')
        return data

    @verify_client
    def appearance_summary(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                        self.client.slugify(character_name), 'appearance')
        return data

    @verify_client
    def collections(self, locale: str, realm_name: str, character_name: str,
        ...
        if category is not None:
            ...
            data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character',
                                                            self.client.slugify(realm_name),
                                                            self.client.slugify(character_name), 'collections',
                                                            category.lower())
        else:
            data = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                            self.client.slugify(character_name), 'collections')

        return data

    @verify_client
    def encounters(self, locale: str, realm_name: str, character_name: str, category: Optional[str] = None) -> Dict[str, Any]:
        ...
        if category is not None:
            ...
            data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character',
                                                            self.client.slugify(realm_name),
                                                            self.client.slugify(character_name), 'encounters',
    ...
    @verify_client
    def equipment_summary(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                        self.client.slugify(character_name), 'equipment')
        return data

    @verify_client
    def hunter_pets_summary(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                       self.client.slugify(character_name), 'hunter-pets')
        return data

    @verify_client
    def media_summary(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                       self.client.slugify(character_name), 'character-media')
        return data

    @verify_client
    def mythic_keystone(self, locale: str, realm_name: str, character_name: str,
        ...
        if season_id:
            data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character',
                                                            ...
                                                            'mythic-keystone-profile', 'season', season_id)
        else:
            data = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                            self.client.slugify(character_name), 'mythic-keystone-profile')

        return data

    @verify_client
    def professions_summary(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                        self.client.slugify(character_name), 'professions')
        return data

    @verify_client
    def profile(self, locale: str, realm_name: str, character_name: str, status: bool = False) -> Dict[str, Any]:
        ...
        if status:
            data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character',
                                                            self.client.slugify(realm_name),
                                                            self.client.slugify(character_name), 'status')
        else:
            data = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                            self.client.slugify(character_name))
        return data
    ...
    @verify_client
    def pvp(self, locale: str, realm_name: str, character_name: str, pvp_bracket: Optional[str] = None) -> Dict[str, Any]:
        ...
        if pvp_bracket is not None:
            data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character',
                                                            self.client.slugify(realm_name),
                                                            self.client.slugify(character_name), 'pvp-bracket',
                                                            pvp_bracket)
        else:
            data = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                            self.client.slugify(character_name), 'pvp-summary')
        return data

    @verify_client
    def quests(self, locale: str, realm_name: str, character_name: str, completed: bool = False) -> Dict[str, Any]:
        ...
        if completed:
            data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character',
                                                            self.client.slugify(realm_name),
                                                            self.client.slugify(character_name), 'quests', 'completed')
        else:
            data = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                            self.client.slugify(character_name), 'quests')
        return data

    @verify_client
    def reputations_summary(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                        self.client.slugify(character_name), 'reputations')
        return data

    @verify_client
    def soulbinds(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                        self.client.slugify(character_name), 'soulbinds')
        return data

    @verify_client
    def specializations_summary(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                        self.client.slugify(character_name), 'specializations')
        return data

    @verify_client
    def statistics_summary(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                        self.client.slugify(character_name), 'statistics')
        return data

    @verify_client
    def title_summary(self, locale: str, realm_name: str, character_name: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.profile_data(locale, 'profile', 'character', self.client.slugify(realm_name),
                                                        self.client.slugify(character_name), 'titles')
        return data
