...
class RealmAPI:
    ...
    def realm(self, locale: str, realm_name: Optional[str] = None) -> Dict[str, Any]:
        ...
        if realm_name is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'dynamic', 'realm', self.client.slugify(realm_name))
        else:
    ...
    def realm_search(self, locale: str, field_values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.search(locale, 'dynamic', 'realm', field_values)
        return data
