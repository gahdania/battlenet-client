...
class AzeriteAPI:
    ...
    @verify_client
    def azerite_essence(self, locale: str, essence_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if essence_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'azerite-essence', essence_id)
        else:
    ...
    @verify_client
    def azerite_essence_search(self, locale: str, field_values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.search(locale, 'static', 'azerite-essence', field_values)
        return data
    ...
    def azerite_essence_media(self, locale: str, essence_id: int) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.media_data(locale, 'static', 'azerite-essence', essence_id)
        return data
