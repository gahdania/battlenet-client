...
class CreatureAPI:
    ...
    def creature_family(
        ...
        if family_id is not None:
            data: Dict[str, Any] = self.client.game_data(
                locale, "static", "creature-family", family_id
            )
        else:
    ...
    def creature_type(
        ...
        if type_id is not None:
            data: Dict[str, Any] = self.client.game_data(
                locale, "static", "creature-type", type_id
            )
        else:
    ...
    def creature(self, locale: str, creature_id: int) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.game_data(
            locale, "static", "creature", creature_id
        )
        return data

    @verify_client
    def creature_search(
        self, locale: str, field_values: Dict[str, Union[str, int]]
    ) -> Dict[str, Any]:
        ...
        data: Dict[str, Any] = self.client.search(
            locale, "static", "creature", field_values
        )
        return data
    ...
    def creature_display_media(self, locale: str, display_id: int) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.media_data(
            locale, "static", "creature-display", display_id
        )
        return data
