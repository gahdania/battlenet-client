...
class QuestAPI:
    ...
    def quest(self, locale: str, quest_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if quest_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'quest', quest_id)
        else:
            data = self.client.game_data(locale, 'static', 'quest', 'index')
        return data

    @verify_client
    def quest_area(self, locale: str, quest_area_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if quest_area_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'quest', 'area', quest_area_id)
        else:
            data = self.client.game_data(locale, 'static', 'quest', 'area', 'index')
        return data

    @verify_client
    def quest_category(self, locale: str, quest_category_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if quest_category_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'quest', 'category', quest_category_id)
        else:
            data = self.client.game_data(locale, 'static', 'quest', 'category', 'index')
        return data

    @verify_client
    def quest_type(self, locale: str, quest_type_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if quest_type_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'quest', 'type', quest_type_id)
        else:
