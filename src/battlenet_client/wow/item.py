...
class ItemAPI:
    ...
    def item_class(self, locale: str, class_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if class_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'item-class', class_id)
        else:
    ...
    def item_set(self, locale: str, set_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if set_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'item-set', set_id)
        else:
    ...
    @verify_client
    def item_subclass(self, locale: str, class_id: int, subclass_id: int) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.game_data(locale, 'static', 'item-class', class_id, 'item-subclass',
                                                     subclass_id)
        return data
    ...
    def item_search(self, locale: str, field_values: Dict[str, Any]):
        ...
        """
        data: Dict[str, Any] = self.client.search(locale, 'static', 'item', field_values)
        return data
