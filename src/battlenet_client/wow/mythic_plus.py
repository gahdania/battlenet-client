...
class MythicPlusAPI:
    ...
    @verify_client
    def mythic_keystone_affix(self, locale: str, affix_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if affix_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'static', 'keystone-affix', affix_id)
        else:
    ...
    def mythic_keystone_affix_media(self, locale: str, affix_id: int) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.media_data(locale, 'static', 'keystone-affix', affix_id)
        return data

    @verify_client
    def mythic_keystone_dungeon(self, locale: str, dungeon_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if dungeon_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'dynamic', 'mythic-keystone', 'dungeon', dungeon_id)
        else:
            data = self.client.game_data(locale, 'dynamic', 'mythic-keystone', 'dungeon', 'index')
        return data
    ...
    def mythic_keystone_index(self, locale: str) -> Dict[str, Any]:
        ...
        """
        data: Dict[str, Any] = self.client.game_data(locale, 'dynamic', 'mythic-keystone', 'index')
        return data

    @verify_client
    def mythic_keystone_period(self, locale: str, period_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if period_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'dynamic', 'mythic-keystone', 'period', period_id)
        else:
            data = self.client.game_data(locale, 'dynamic', 'mythic-keystone', 'period', 'index')
        return data

    @verify_client
    def mythic_keystone_season(self, locale: str, season_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if season_id is not None:
            data: Dict[str, Any] = self.client.game_data(locale, 'dynamic', 'mythic-keystone', 'season', season_id)
        else:
            data = self.client.game_data(locale, 'dynamic', 'mythic-keystone', 'season', 'index')
        return data

    @verify_client
    def mythic_keystone_leader_board(self, locale: str, connected_realm_id: int, dungeon_id: Optional[int] = None,
        ...
        if dungeon_id and period_id:
            data: Dict[str, Any] = self.client.game_data(locale, 'dynamic', 'connected-realm', connected_realm_id,
                                                         'mythic-leaderboard', dungeon_id, 'period', period_id)
        else:
            data = self.client.game_data(locale, 'dynamic', 'connected-realm', connected_realm_id, 'mythic-leaderboard',
                                         'index')
        return data
